...
//Transmitter Code that sends messages from control panel to top of robot
...
const byte addr = 0x73; // change as per the above assignment
const int RF24_CHANNEL_NUMBER = 40; // change as per the above assignment
...
void loop() {
  ...
  if (digitalRead(XMIT1PIN) == LOW) {  // remember switches are active LOW
    ...
    Serial.print(F("XMTR: sending data = "));
